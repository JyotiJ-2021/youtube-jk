...
const Navbar = () => {
  ...
  const user= 
    JSON.parse(localStorage.getItem("yuser")) || ''
    ...
    <>
      <div className="nav">
        ...
        <div className="right">
          ...
          <AccountCircleOutlinedIcon onClick={()=> setOpenRightDrawer(!openRightDrawer)} />
        ...
        <AccountCircleOutlinedIcon onClick={()=> setOpenRightDrawer(!openRightDrawer)}  />
          ...
          >
           ...
           {isLogin
            ...
            :
            <List  style={{padding:"20px 5px"}}>
            <ListItem><Link to="/signin" >Sign In</Link> </ListItem>
            </List>
        }  
          </Drawer>
    </>
